...
RAND_SEED = 0
# LEARNING_RATE = 0.0005  # 0 -10 -20dB
LEARNING_RATE = 0.001
MODEL_PATH = 'MLP_LSTM_MLP.pth'
train_audio_feature_path = r'E:/Orignal_F/PyCharm/pythonProject3/MobileNetV2_Audio_Feature/train_audio_features'
test_audio_feature_path = r'E:/Orignal_F/PyCharm/pythonProject3/MobileNetV2_Audio_Feature/test_audio_features'
...
class LSTM(nn.Module):
    ...
    def forward(self, x, hidden):
        ...
        predictions = self.linear2(lstm_out)
...
plt.figure()
plt.plot(all_losses)
plt.title('MobileNetv2_Baseline')
...
plt.title('MobileNetv2_Test_accuracy')
plt.xlabel('Training Epochs')
