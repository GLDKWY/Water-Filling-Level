...
MODEL_PATH = 'Different_Content_LSTM_MLP.pth'
train_audio_feature_path = r'E:/Orignal_F/PyCharm/pythonProject3/PANNS_Audio_Feature/Sand_features_train'
test_audio_feature_path = r'E:/Orignal_F/PyCharm/pythonProject3/PANNS_Audio_Feature/Different_Content'
train_label_path = r'E:/Orignal_F/PyCharm/pythonProject3/labels/Sand_labels_train'
test_label_path = r'E:/Orignal_F/PyCharm/pythonProject3/labels/Different_Content_Labels'
...
class LSTM(nn.Module):
    ...
    def forward(self, x, hidden):
        ...
        embedding = embedding.view(batch_size, 8, -1)
...
model.load_state_dict(torch.load('Different_Content_LSTM_MLP.pth'))
# name_list = ['fc1.weight', 'fc1.bias', 'linear.weight', 'linear.bias']
...
for epoch in range(epochs):
    ...
    # all_errors.append(abs(epoch_error / batch_size / (batch_idx + 1) / 8))
    # all_losses.append(epoch_loss / (batch_idx + 1))
    # print('epoch_error:', epoch_error / batch_size / (batch_idx + 1) / 8)
    # print('[epochs: %d] MSE_loss: %.3f' % (epoch + 1, epoch_loss / (batch_idx + 1)))
    #
