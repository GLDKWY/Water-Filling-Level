...
RAND_SEED = 0
LEARNING_RATE = 0.0001  # 0 -10dB
MODEL_PATH = 'LSTM_MLP.pth'
train_audio_feature_path = r'E:/Orignal_F/PyCharm/pythonProject3/MFCCs_Feature/feature_mfcc_train'
test_audio_feature_path = r'E:/Orignal_F/PyCharm/pythonProject3/MFCCs_Feature/feature_mfcc_test'
...
class LSTM(nn.Module):
    ...
    def forward(self, input_seq, hidden):
        input_seq = self.linear2(input_seq)  # [4, 384, 8]
...
model = LSTM(input_size=384, hidden_layer_size=1024, output_size=1, num_layers=2, bidirectional=True)
